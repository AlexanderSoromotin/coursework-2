            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="login" placeholder="Введите логин от учётной записи">
                    </div>
                    <div class="form-group">
                        <label for="password">Пароль</label>
                        <input type="password" class="form-control" id="password" placeholder="Введите пароль">
                    </div>
                    <button type="button" class="login btn btn-primary">Войти</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(".login").click(function () {
        ...
        if (login == "") {
            showErrorNotification("Введите логин");
            return;
        }
        if (password == "") {
            showErrorNotification("Введите пароль");
            return;
        }

        $(".login").text("Отправка запроса ...");
        ...
        $.ajax({
            ...
            success: (response) => {
                console.log("success POST /login", response);
                localStorage.setItem("user_token", response.access_token)
                $(".login").text("Выполняем вход ...");
                location.href="{{ url("/employees") }}";
            },
            error: (response) => {
                console.log("error POST /login", response);
